...
frappe.setup.on("before_load", function () {
	condos.setup.slides_settings.map(frappe.setup.add_slide);
});

condos.setup.slides_settings = [
	{
		// Domain
		name: 'domain',
	...
	},
	{
		...
		set_fy_dates: function (slide) {
			...
			if (country) {
				var fy = condos.setup.fiscal_years[country];
