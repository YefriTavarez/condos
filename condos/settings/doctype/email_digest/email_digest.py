...
from condos.financials.utils import get_balance_on, get_count_on
...
class EmailDigest(Document):
	...
	def get_msg_html(self):
		...
		from condos.setup.doctype.email_digest.quotes import get_random_quote
		...
		# style
		return frappe.render_template("condos/setup/doctype/email_digest/templates/default.html",
