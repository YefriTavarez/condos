...
cur_frm.cscript.refresh = function(doc, dt, dn) {
	...
	var err_msg = __("There was an error. One probable reason could be that you haven't saved the form. Please contact support@condos.com if the problem persists.")

	cur_frm.add_custom_button(__('View Now'), function() {
		frappe.call({
			method: 'condos.settings.doctype.email_digest.email_digest.get_digest_msg',
			args: {
				name: doc.name
			},
			callback: function(r) {
