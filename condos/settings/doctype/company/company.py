...
class Company(Document):
	...
	def create_default_accounts(self):
		from condos.financials.doctype.account.chart_of_accounts.chart_of_accounts import create_charts
...
def enqueue_replace_abbr(company, old, new):
	...
	frappe.enqueue('condos.settings.doctype.company.company.replace_abbr', **kwargs)
