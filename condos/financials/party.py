...
from condos.exceptions import PartyFrozen, PartyDisabled, InvalidAccountCurrency
from condos.financials.utils import get_fiscal_year
from condos import get_default_currency, get_company_currency
...
def set_taxes(party, party_type, posting_date, company, customer_group=None, supplier_type=None,
	...
	from condos.financials.doctype.tax_rule.tax_rule import get_tax_template, get_party_details
	args = {
		party_type.lower(): party,
		"company":			company
	}
