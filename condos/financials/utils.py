...
# imported to enable condos.financials.utils.get_account_currency
from condos.financials.doctype.account.account import get_account_currency
...
def get_children(doctype, parent, company, is_root=False):
	from condos.financials.report.financial_statements import sort_root_accounts
