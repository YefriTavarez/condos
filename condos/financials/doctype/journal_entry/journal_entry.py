...
from condos.financials.utils import get_balance_on, get_account_currency
...
class JournalEntry(AccountsController):
	...
	def on_cancel(self):
		from condos.accounts.utils import unlink_ref_doc_from_payment_entries
		from condos.hr.doctype.salary_slip.salary_slip import unlink_ref_doc_from_salary_slip
	...
	def check_credit_limit(self):
		...
		if customers:
			from condos.selling.doctype.customer.customer import check_credit_limit
	...
	def make_gl_entries(self, cancel=0, adv_adj=0):
		from condos.accounts.general_ledger import make_gl_entries
