...
import frappe, condos, json
from frappe import _, scrub, ValidationError
from frappe.utils import flt, comma_or, nowdate
from condos.financials.utils import get_outstanding_invoices, get_account_currency, get_balance_on
from condos.financials.party import get_party_account
from condos.financials.doctype.journal_entry.journal_entry import get_default_bank_cash_account
...
def get_reference_details(reference_doctype, reference_name, party_account_currency):
	...
	company_currency = ref_doc.get("company_currency") or condos.get_company_currency(ref_doc.company)
