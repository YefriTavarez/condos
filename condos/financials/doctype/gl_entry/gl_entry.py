...
from condos.financials.party import validate_party_gle_currency, validate_party_frozen_disabled
from condos.financials.utils import get_account_currency
from condos.financials.utils import get_fiscal_year
from condos.exceptions import InvalidAccountCurrency
...
class GLEntry(Document):
	...
	def on_update_with_args(self, adv_adj, update_outstanding = 'Yes', from_repost=False):
		...
		if self.against_voucher_type in ['Journal Entry', 'Payment Entry'] \
	...
	def validate_currency(self):
		company_currency = condos.get_company_currency(self.company)
